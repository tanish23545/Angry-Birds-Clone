...
//        sampleBird = new BlueBird(world,120, 200);
        ...
        birdsQueue.add(new RedBird(world, 150,100));
        birdsQueue.add(new BlueBird(world, 100,100));
        birdsQueue.add(new RedBird(world, 50,100));
        slingshot = new Slingshot(200, 115);

        loadNextBird();
        pigs.add(new MediumPig(world, 800, 350));
        pigs.add(new KingPig(world, 1100, 350));
        pigs.add(new SmallPig(world, 1400, 350));
        materials.add(new WoodV(world,800, 200));
        materials.add(new WoodV(world,1100, 200));
        materials.add(new StoneV(world,1400, 200));
        materials.add(new StoneH(world,800, 300));
        materials.add(new GlassH(world,1100, 300));
        materials.add(new GlassH(world,1400, 300));
        createGround();
//        createBird();
        createBackButton();
